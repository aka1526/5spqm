           ...
           <div class="col-xl-12">
             <div class="ibox ibox-primary">
               <div class="ibox-head">
                   ...
                   <div>
                       <a class="btn btn-warning btn-sm " href="{{ '/check/byscore?year='.$year.'&month='.$month}}"><i class="fa fa-backward"></i> กลับ</a>
                  ...
                  <div class="ibox-body ">
                      <div class="row">
                          ...
                          <div class="col-sm-6 form-group">
                            <label>ประจำปี</label>
                              <input class="form-control" type="text" value="{{ $year}} " readonly>
                        </div>
                        <div class="col-sm-6 form-group">
                            <label>วันที่</label>
                              <input class="form-control" type="text" value="{{ $plan_date }} " readonly>
                        </div>
                      </div>
                  </div>
              </div>
